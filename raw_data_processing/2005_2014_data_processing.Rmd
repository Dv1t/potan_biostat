...
D2005_2014 <- D2005_2014 %>% mutate(ID = 1:nrow(D2005_2014)) %>%
  filter(ID %notin% c(487, 1327, 1602, 133, 1121, 938, 1080, 1151, 1633, 1109, 1632, 1379, 1287, 1075, 1071, 321, 766, 439, 1167, 31, 6, 381, 1175, 56, 604, 367, 228, 483, 234, 68, 412, 483, 1380, 1067, 888, 377, 609, 629, 1358, 654, 281, 1508, 1728, 680, 1741, 1605, 1715, 1463, 250, 924, 1577, 1429, 433, 99, 1086, 1553, 1524, 901, 749)) %>%
  mutate(ID = NULL)
...
author_compare <- read_excel("Data/Processed/D2005_D2014_authors.xlsx")
...
author_compare %>% 
  ...
  geom_point(aes(alpha = 0.6, size = 1.5)) +
  theme_minimal() + 
